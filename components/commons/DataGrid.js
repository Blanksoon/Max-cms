  ...
  constructor(props) {
    ...
    this.columns = [
      ...
      },
      {
        ...
        width: '20%',
        render: (text, record) =>
          this.renderColumns(text, record, 'first_name'),
      },
      {
        title: 'นามสกุล',
        dataIndex: 'last_name',
      ...
      },
      {
        ...
        width: '10%',
        render: (text, record) =>
          this.renderColumns(text, record, 'credit_name'),
      },
      {
        title: 'วงเงิน',
        ...
        width: '10%',
        render: (text, record) =>
          this.renderColumns(text, record, 'moneyLimit'),
      },
      {
        title: 'สถานะ',
        dataIndex: 'status',
      ...
      },
      {
        ...
        width: '10%',
        render: (text, record) =>
          this.renderColumns(text, record, 'create_date'),
      },
      {
        title: 'Code',
        dataIndex: 'code',
